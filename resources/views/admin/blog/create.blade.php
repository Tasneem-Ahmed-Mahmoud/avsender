                        ...
                        <div class="from-group row col-12">
                            ...
                            <div class="col-lg-12">
                                <textarea name="content[en]" rows="40"
                                    class="summernote form-control">{!!  old('content.en')??'' !!}</textarea>
                            </div>
                        ...
                        <div class="from-group row col-12">
                            ...
                            <div class="col-lg-12">
                                <textarea name="content[ar]" rows="40"
                                    class="summernote form-control">{!! old('content.ar')??'' !!}</textarea>
                            </div>
                        ...
                        <div class="from-group row  col-6">
                            ...
                            <div class="col-lg-12">
                                <select name="categories[]" class="form-control select2" multiple="">
                                    ...
                                    <option value="{{ $category->id }}" @selected(in_array($category->id,old('categories',[])))> {{ $category->title }} </option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
