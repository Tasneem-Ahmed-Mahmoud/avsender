			...
			<div class="col">
				<div class="card card-stats">
					<div class="card-body">
						...
						<p class="mt-3 mb-0 text-sm">
						</p><h5 class="card-title  text-muted mb-0">{{ __('Today s Messages') }}</h5>
						<p></p>
					</div>
				</div>
			</div>
			...
			<div class="card-header border-0">
				...
				<form action="" class="card-header-form">
					<div class="input-group">
						<input type="text" name="search" value="{{ $request->search ?? '' }}" class="form-control" placeholder="{{ __('Search......2') }}">
