...
<div class="row">
    ...
    <div class="col-12 m-auto">
        <form  action="{{ route('admin.plan.store') }}" enctype="multipart/form-data"
            method="POST">
            @csrf
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="plan_title_en" value="{{ old('title.en') }}"
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="plan_title_ar" value="{{ old('title.ar') }}"
                                name="title[ar]" required>
                            @error('title.ar')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="business_size_en"
                                value="{{ old('business_size.en') }}" name="business_size[en]" required>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="business_size_ar"
                                value="{{ old('business_size.ar') }}" name="business_size[ar]" required>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="plan_description_en"
                                value="{{ old('description.en') }}" name="description[en]" required>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="plan_description_ar"
                                value="{{ old('description.ar') }}" name="description[ar]" required>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="messages_limit"
                                value="{{ old('limits.messages_limit') ?? '' }}" name="limits[messages_limit]" required>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="contact_limit"
                                value="{{ old('limits.contact_limit') ?? '' }}" name="limits[contact_limit]" required>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="device_limit"
                                value="{{ old('limits.device_limit') ?? '' }}" name="limits[device_limit]" required>
                        ...
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="template_limit"
                                value="{{ old('limits.template_limit') ?? '' }}" name="limits[template_limit]" required>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="text" class="form-control" id="apps_limit"
                                value="{{ old('limits.apps_limit') ?? '' }}" name="limits[apps_limit]" required>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <input type="file" class="form-control" id="plan_icon" name="icon" value="{{ old('icon') ?? '' }}">
                            @error('icon')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="form-group col-6">
                            ...
                            <input type="number" class="form-control" id="plan_price" name="price" step="any" required value="{{ old('price') ?? '' }}">
                            @error('price')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="plan_duration" name="days" required>
                                <option value="30" {{ old('days')==30 ? 'selected' : '' }}>{{ __('Monthly') }}</option>
                                <option value="365" {{ old('days')==365 ? 'selected' : '' }}>{{ __('Yearly') }}</option>
                            </select>
                            @error('days')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="access_group_list" name="limits[access_group_list]" required>
                                <option value="1" {{ old('limits.access_group_list')==1 ? 'selected' : '' }}>{{ __('Enable') }}
                                </option>
                                <option value="0" {{ old('limits.access_group_list')==0 ? 'selected' : '' }}>{{ __('Disable')
                                    }}</option>
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="chatbot" name="limits[chatbot]" required>
                                <option value="1" {{ old('limits.chatbot')==1 ? 'selected' : '' }}>{{ __('Enable') }}</option>
                                <option value="0" {{ old('limits.chatbot')==0 ? 'selected' : '' }}>{{ __('Disable') }}</option>
                            </select>
                            @error('chatbot')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="bulk_message" name="limits[bulk_message]" required>
                                <option value="1" {{ old('limits.bulk_message')==1 ? 'selected' : '' }}>{{ __('Enable') }}
                                </option>
                                <option value="0" {{ old('limits.bulk_message')==0 ? 'selected' : '' }}>{{ __('Disable') }}
                                </option>
                            </select>
                    ...
                    <div class="row">
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="schedule_message" name="limits[schedule_message]" required>
                                <option value="1" {{ old('limits.schedule_message')==1 ? 'selected' : '' }}>{{ __('Enable') }}
                                </option>
                                <option value="0" {{ old('limits.schedule_message')==0 ? 'selected' : '' }}>{{ __('Disable') }}
                                </option>
                            </select>
                        ...
                        <div class="form-group col-6">
                            ...
                            <select class="form-control" id="access_chat_list" name="limits[access_chat_list]" required>
                                <option value="1" {{ old('limits.access_chat_list')==1 ? 'selected' : '' }}>{{ __('Enable') }}
                                </option>
                                <option value="0" {{ old('limits.access_chat_list')==0 ? 'selected' : '' }}>{{ __('Disable') }}
                                </option>
                            </select>
                    ...
                    <div class="row justify-content-between">
                        ...
                        <div class="form-group col-3">
                            <div class="d-flex">
                                <label class="custom-toggle custom-toggle-primary">
                                    <input type="checkbox" name="is_recomended" id="is_recomended"
                                        @checked(old('is_recomended'))>
                                    <span class="custom-toggle-slider rounded-circle" data-label-off="No"
                                        data-label-on="Yes"></span>
                                </label>
                                <label class="mt-1 ml-1" for="is_recomended">
                        ...
                        <div class="form-group col-3">
                            <div class="d-flex">
                                <label class="custom-toggle custom-toggle-primary">
                                    <input type="checkbox" name="status" id="status" @checked(old('status'))>
                                    <span class="custom-toggle-slider rounded-circle" data-label-off="No"
                                        data-label-on="Yes"></span>
                                </label>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="form-group trial-days col-12 d-none">
                            ...
                            <input type="number" name="trial_days" value="{{ old('trial_days') ?? '' }}"
                                class="form-control">
                            @error('trial_days')
                            <span class="text-danger">{{ $message }}</span>
                            @enderror
                ...
                <div class="form-group row mt-3">
                    <div class="col-lg-12 d-flex justify-content-center">
                        <button  type="submit" class="btn btn-neutral submit-button btn-sm w-50 text-center mb-4 py-2">{{ __('Save')
                            }}</button>
                    </div>
                </div>
            </div>
