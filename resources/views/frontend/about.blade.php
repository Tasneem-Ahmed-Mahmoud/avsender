...
@section('content')
    @include('frontend.inc.head-2', [
        'title' => __('About Us'),
        'description' => $about->breadcrumb_title ?? '',
    ])
                ...
                <div class="col-md-3 col-6">
                    <div class="about-statistic__conten d-flex ">
                        ...
                        <div class="about-statistic-right d-flex flex-column">
                            ...
                            <h4><span class="counter" data-count="{{ $counter->satisfied_customers ?? '' }}">0</span>+
                            </h4>
                            ...
                            <div class="faq_box_content faq_box_content-home">
                                <div class="w-100 d-flex flex-column justify-content-between">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center w-100">
                                        ...
                                        <span class="faq_box_content-p" id="faqQuestion{{ $loop->iteration }}">
                                            {{ $faq->title }}
                                        </span>
                                        <div class="more-info-faq-div" id="more-info-faq-div">
                                            <img src="{{ asset('frontend/assets/images/faq') }}/more-info-faq.svg"
                                                alt="more-info-faq" class="more-info-faq" data-bs-toggle="collapse"
                                                href="#collapseExample{{ $loop->iteration }}" role="button"
                                                aria-expanded="false"
                                                aria-controls="collapseExample{{ $loop->iteration }}" id="toggleImage" />
                                        </div>
                                    </div>
...
@section('script')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('a > [class*="col-lg-"], a > [class*="col-md-"], a > [class*="col-sm-"]')
