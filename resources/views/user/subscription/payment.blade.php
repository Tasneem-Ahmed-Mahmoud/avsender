...
<div class="col-sm-12">
   <div class="alert alert-danger alert-dismissible fade show" role="alert">
    ...
    <span class="alert-text"><strong>{{ __('!Oops ') }}</strong> {{ __('Transaction failed if you make payment successfully please contact us.') }}</span>
...
<div class="col-sm-12">
   <div class="alert alert-danger alert-dismissible fade show" role="alert">
    <span class="alert-icon"><i class="fas fa-sad-tear"></i></span>
    <span class="alert-text"><strong>{{ __('!Oops ') }}</strong> {{ Session::get('min-max') }}</span>
    <button type="button" class="close" data-dismiss="alert" aria-label="{{ __('Close2') }}">
      <span aria-hidden="true">×</span>
   </button>
</div>
...
<div class="col-sm-12">
   ...
   <table class="items table mt-2">
      ...
      <tr class="title">
         <td class="textright">{{ __('Total:') }}</td>
