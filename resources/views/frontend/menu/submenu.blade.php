...
<li class="nav-item dropdown">
    ...
    <a class="nav-link dropdown-toggle text-capitalize" href="#" id="navbarDropdown-sub" role="button"
        data-bs-toggle="dropdown" aria-expanded="false" href="{{ url($childrens->href) }}"
...
@else
<a class="dropdown-item" href="{{ url($childrens->href) }}" @if(!empty($childrens->target)) target="{{
    $childrens->target }}" @endif>{{ $childrens->text }}</a>
@endif
</li>
@endif