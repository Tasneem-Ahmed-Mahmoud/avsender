...
<div class="row justify-content-center">
                ...
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-9">
                        <div class="tab-content no-padding" id="myTab2Content">
                            ...
                            <div class="alert text-danger text-danger d-flex align-items-center" role="alert" style='background-color:rgb(241, 198, 198)' @if(app()->getLocale() == 'ar') dir="rtl" @else dir="ltr" @endif>
    <i class="fa-solid fa-circle-xmark" style='font-size:30px; margin-right:10px; margin-left:10px; '></i> 
    <p class='ms-2 me-2'>
        @if(app()->getLocale() == 'ar')
            هناك مشكلة مع خدمة رسالة مع زر من قبل واتس آب
        @else
            There is a problem with the message with button service from WhatsApp
        @endif
    </p>
</div>
    ...
    <p class='ms-2 me-2'>
        @if(app()->getLocale() == 'ar')
            هناك مشكلة مع خدمة   قائمة الرسائل من قبل واتس آب
        @else
            There is a problem with the list message service from WhatsApp
        @endif
    </p>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content d-flex flex-column align-items-center justify-content-center">
            <div class="modal-header">
                <h5 class="modal-title" id="warningModalLabel"><i class="fas fa-exclamation-triangle text-warning" style='font-size:50px'></i></h5>
            </div>
            <div class="modal-body">
                <p id="modalMessage"></p>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn text-light fw-bold fs-2" data-bs-dismiss="modal" style='background-color:#1937e4'>Close</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        // Select all links with the specified classes
        ...
        links.forEach(function(link) {
            link.addEventListener('click', function(event) {
                ...
                // Get the message based on the link clicked
                var message = '';
                if (link.textContent.trim() === '{{ __('Message With Button') }}') {
                    message = 'There is a problem with the message with button.';
                } else if (link.textContent.trim() === '{{ __('List Message') }}') {
                    message = 'There is a problem with the list message.';
                }
