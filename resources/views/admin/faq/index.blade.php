         ...
         <form method="POST" action="{{ route('admin.faq.store') }}" class="ajaxform_instant_reload">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                 ...
                 <textarea class="form-control h-100" maxlength="10000" name="answer" required=""></textarea>
               </div>
      ...
      <div class="modal-content">
         <form method="POST" action="" class="ajaxform_instant_reload edit-modal">
            ...
            <div class="modal-body">
               ...
               <div class="form-group">
                  <label>{{ __('Answer') }}</label>
                 <textarea class="form-control h-100" maxlength="10000" name="answer" required="" id="answer"></textarea>
               </div>
