...
<main>
      ...
      <div class="container">
         <div class="row justify-content-center   ">
            <div class="col-lg-9 col-md-12">
               <div class="about-inner__section-box mb-70 text-center wow tpfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".3s">
                  <span class="about-inner__subtitle"></span>
            ...
            <div class="col-xl-5 col-lg-5 wow tpfadeRight" data-wow-duration=".9s" data-wow-delay=".7s">
               <div class="about-inner__right">
                  ...
                  <div class="about-inner__btn d-flex align-items-center">
                     ...
                     <a class="tp-btn-blue-square mr-20" href="{{ $about->button_link }}"><span>{{ $about->button_title
                           }}</span></a>
                     @endif

                     @if(!empty($about->introducing_video))
                     <a class="about-inner__play-btn popup-video" href="{{ $about->introducing_video }}"><i
   ...
   <div id="tp-service__area" class="tp-service__area tp-service__space service-inner grey-bg pt-120 pb-100">
      <div class="container">
         <div class="row">
            <div class="col-12">
               <div class="tp-service__section-wrapper service-inner d-flex justify-content-between wow tpfadeUp"
                  ...
                  <div class="tp-service__inner-btn">
                     <a class="tp-btn-blue-square" href="{{ url('/features') }}"><span>{{ __('See All Features')
                           }}</span></a>
                  </div>
               </div>
            </div>
            ...
            <div class="tp-service__slider-active">
               ...
               <div class="tp-service__item wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".7s">
                  ...
                  <div class="tp-service__content">
                     <h4 class="tp-service__title-sm"><a href="{{ url('feature/'.$feature->slug) }}">{{
                           Str::limit($feature->title,20) }}</a></h4>
         ...
         <div class="container">
            <div class="row ">
               <div class="col-12 wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".5s">
                  <div class="tp-team__section-box d-flex flex-column justify-content-center align-items-center w-100">
                     <h3 class="tp-section-title-md  w-100  ">{{ __('Meet with our') }} <br> {{ __('team') }}</h3>
                     <div class="tp-team__btn">
                        <a class="tp-btn-pink mb-15" href="{{ url('/team') }}"><span>{{ __('All Team Member')
                              }}</span></a>
                        <a class="tp-btn-sky-sm mb-15 ml-15" href="{{ url('/contact') }}"><span>{{ __('Join our Team')
                              }}</span></a>
                     </div>
                  </div>
               </div>
            ...
            <div class="row">
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6 mb-70 wow tpfadeUp" data-wow-duration=".9s"
                  data-wow-delay=".6s">
                  ...
                  <div class="accordion" id="accordionExample">
                     ...
                     <div class="accordion-items">
                        <h2 class="accordion-header" id="heading-{{ $key+1 }}">
                           <button class="accordion-buttons {{ $key > 0 ? 'collapsed' : '' }}" type="button"
                              data-bs-toggle="collapse" data-bs-target="#collapse-{{ $key+1 }}"
                              aria-expanded="{{ $key == 0 ? true : false }}" aria-controls="collapse-1">
                              {{ $faq->title }}
                           </button>
                        </h2>
                        <div id="collapse-{{ $key+1 }}"
                           class="accordion-collapse collapse {{ $key == 0 ? 'show' : '' }}"
                           aria-labelledby="heading-{{ $key+1 }}" data-bs-parent="#accordionExample-2">
            ...
            <div class="col-md-6">
               <div class="content p-1">
                  ...
                  <div class="about-inner__list">
                     <ul>
                        @foreach($facilities as $facility)
                        <li class="d-flex align-items-center "> <i class="fa-solid  fa-check"></i> <span>{{ $facility }}</span></li>
                        @endforeach
                     </ul>
                  </div>
